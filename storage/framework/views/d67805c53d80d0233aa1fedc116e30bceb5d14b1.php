...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('09zAGY6')) {
    $componentId = $_instance->getRenderedChildComponentId('09zAGY6');
    $componentTag = $_instance->getRenderedChildComponentTagName('09zAGY6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('09zAGY6');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('09zAGY6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('at42BzQ')) {
    $componentId = $_instance->getRenderedChildComponentId('at42BzQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('at42BzQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('at42BzQ');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('at42BzQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('HptchwF')) {
    $componentId = $_instance->getRenderedChildComponentId('HptchwF');
    $componentTag = $_instance->getRenderedChildComponentTagName('HptchwF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HptchwF');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('HptchwF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH C:\Users\typej\Documents\git\panexpres\resources\views/externalviews/view-details.blade.php ENDPATH**/ ?>