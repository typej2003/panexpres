...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('7ugcDG4')) {
    $componentId = $_instance->getRenderedChildComponentId('7ugcDG4');
    $componentTag = $_instance->getRenderedChildComponentTagName('7ugcDG4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7ugcDG4');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('7ugcDG4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('LPWYig2')) {
    $componentId = $_instance->getRenderedChildComponentId('LPWYig2');
    $componentTag = $_instance->getRenderedChildComponentTagName('LPWYig2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LPWYig2');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('LPWYig2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('OyN7ltQ')) {
    $componentId = $_instance->getRenderedChildComponentId('OyN7ltQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('OyN7ltQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OyN7ltQ');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('OyN7ltQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
