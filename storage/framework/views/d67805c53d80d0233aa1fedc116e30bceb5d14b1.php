...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('8x8nzWv')) {
    $componentId = $_instance->getRenderedChildComponentId('8x8nzWv');
    $componentTag = $_instance->getRenderedChildComponentTagName('8x8nzWv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8x8nzWv');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('8x8nzWv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('7TOyWx0')) {
    $componentId = $_instance->getRenderedChildComponentId('7TOyWx0');
    $componentTag = $_instance->getRenderedChildComponentTagName('7TOyWx0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7TOyWx0');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('7TOyWx0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('PRtBIjc')) {
    $componentId = $_instance->getRenderedChildComponentId('PRtBIjc');
    $componentTag = $_instance->getRenderedChildComponentTagName('PRtBIjc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PRtBIjc');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('PRtBIjc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
