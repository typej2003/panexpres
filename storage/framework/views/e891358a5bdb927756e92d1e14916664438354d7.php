...
<?php endif; ?>
                    ...
                    <div class="card">
                        <div class="card-header">Total de Usuarios: <?php echo e(count($result)); ?></div>
                        <div class="card-body">
                            <div class="row ">
                                <?php for($i = 0; $i < count($result); $i++): ?>
                                    <div class="col-md-3 col-4">
                                        <div class="card w-100 shadow">
                                            <div class="card-body">
                                                <h4>id: <?php echo e($result[$i]['.id']); ?></h4>
                                                <h2><?php echo e($result[$i]['name']); ?></h2>
                                                <h3>Grupo: <?php echo e($result[$i]['group']); ?></h3>
                                                <h3>Dirección: <?php echo e($result[$i]['address']); ?></h3>
                                                <h3>Caducada: <?php echo e($result[$i]['expired']); ?></h3>
                                                <h3>Desactivada: <?php echo e($result[$i]['disabled']); ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                <?php endfor; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="" wire:model.defer="state.group" class="form-control <?php $__errorArgs = ['group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH C:\Users\typej\Documents\git\panexpres-1\resources\views/livewire/mikrotik/list-users-mikrotik.blade.php ENDPATH**/ ?>