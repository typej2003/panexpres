...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('v6bDE16')) {
    $componentId = $_instance->getRenderedChildComponentId('v6bDE16');
    $componentTag = $_instance->getRenderedChildComponentTagName('v6bDE16');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('v6bDE16');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('v6bDE16', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('PxS71ZQ')) {
    $componentId = $_instance->getRenderedChildComponentId('PxS71ZQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('PxS71ZQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PxS71ZQ');
} else {
    $response = \Livewire\Livewire::mount('components.promociones');
    $html = $response->html();
    $_instance->logRenderedChild('PxS71ZQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('EySemaK')) {
    $componentId = $_instance->getRenderedChildComponentId('EySemaK');
    $componentTag = $_instance->getRenderedChildComponentTagName('EySemaK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EySemaK');
} else {
    $response = \Livewire\Livewire::mount('components.marcas-productos');
    $html = $response->html();
    $_instance->logRenderedChild('EySemaK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('meZViBA')) {
    $componentId = $_instance->getRenderedChildComponentId('meZViBA');
    $componentTag = $_instance->getRenderedChildComponentTagName('meZViBA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('meZViBA');
} else {
    $response = \Livewire\Livewire::mount('components.show-products', ['comercioId' => $comercio_id, 'currencyValue' => $currencyValue]);
    $html = $response->html();
    $_instance->logRenderedChild('meZViBA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('0DxsjJq')) {
    $componentId = $_instance->getRenderedChildComponentId('0DxsjJq');
    $componentTag = $_instance->getRenderedChildComponentTagName('0DxsjJq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0DxsjJq');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('0DxsjJq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('X7r473D')) {
    $componentId = $_instance->getRenderedChildComponentId('X7r473D');
    $componentTag = $_instance->getRenderedChildComponentTagName('X7r473D');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('X7r473D');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('X7r473D', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
