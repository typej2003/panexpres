...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('MQM3Hg3')) {
    $componentId = $_instance->getRenderedChildComponentId('MQM3Hg3');
    $componentTag = $_instance->getRenderedChildComponentTagName('MQM3Hg3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MQM3Hg3');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('MQM3Hg3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('4qV01Qu')) {
    $componentId = $_instance->getRenderedChildComponentId('4qV01Qu');
    $componentTag = $_instance->getRenderedChildComponentTagName('4qV01Qu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4qV01Qu');
} else {
    $response = \Livewire\Livewire::mount('components.promociones');
    $html = $response->html();
    $_instance->logRenderedChild('4qV01Qu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l6R1XOD')) {
    $componentId = $_instance->getRenderedChildComponentId('l6R1XOD');
    $componentTag = $_instance->getRenderedChildComponentTagName('l6R1XOD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l6R1XOD');
} else {
    $response = \Livewire\Livewire::mount('components.marcas-productos');
    $html = $response->html();
    $_instance->logRenderedChild('l6R1XOD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('jnyffAV')) {
    $componentId = $_instance->getRenderedChildComponentId('jnyffAV');
    $componentTag = $_instance->getRenderedChildComponentTagName('jnyffAV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jnyffAV');
} else {
    $response = \Livewire\Livewire::mount('components.show-products', ['comercioId' => $comercio_id, 'currencyValue' => $currencyValue]);
    $html = $response->html();
    $_instance->logRenderedChild('jnyffAV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('j4azd6z')) {
    $componentId = $_instance->getRenderedChildComponentId('j4azd6z');
    $componentTag = $_instance->getRenderedChildComponentTagName('j4azd6z');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('j4azd6z');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('j4azd6z', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('YR2FC0S')) {
    $componentId = $_instance->getRenderedChildComponentId('YR2FC0S');
    $componentTag = $_instance->getRenderedChildComponentTagName('YR2FC0S');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YR2FC0S');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('YR2FC0S', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\typej\Documents\git\panexpres-1\resources\views/welcome.blade.php ENDPATH**/ ?>