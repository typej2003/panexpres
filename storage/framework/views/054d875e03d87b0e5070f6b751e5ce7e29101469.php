...
} elseif ($_instance->childHasBeenRendered('l3832577356-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3832577356-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3832577356-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3832577356-0');
} else {
    $response = \Livewire\Livewire::mount('admin.profile.basic-data', ['user_id' => auth()->user()->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('l3832577356-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('l3832577356-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3832577356-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3832577356-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3832577356-1');
} else {
    $response = \Livewire\Livewire::mount('admin.profile.billing-details', ['user_id' => auth()->user()->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('l3832577356-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\typej\Documents\git\panexpres-1\resources\views/livewire/admin/profile/update-profile.blade.php ENDPATH**/ ?>