...
} elseif ($_instance->childHasBeenRendered('l154350207-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l154350207-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l154350207-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l154350207-0');
} else {
    $response = \Livewire\Livewire::mount('carrito.cart-drop', ['currencyValue' => $currencyValue ]);
    $html = $response->html();
    $_instance->logRenderedChild('l154350207-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('l154350207-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l154350207-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l154350207-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l154350207-1');
} else {
    $response = \Livewire\Livewire::mount('components.currency');
    $html = $response->html();
    $_instance->logRenderedChild('l154350207-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH C:\Users\typej\Documents\git\panexpres-1\resources\views/livewire/layouts/navbar-in.blade.php ENDPATH**/ ?>