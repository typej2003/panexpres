...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('wsqqxBI')) {
    $componentId = $_instance->getRenderedChildComponentId('wsqqxBI');
    $componentTag = $_instance->getRenderedChildComponentTagName('wsqqxBI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wsqqxBI');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('wsqqxBI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('EkiEhMi')) {
    $componentId = $_instance->getRenderedChildComponentId('EkiEhMi');
    $componentTag = $_instance->getRenderedChildComponentTagName('EkiEhMi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EkiEhMi');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('EkiEhMi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('SvODwIc')) {
    $componentId = $_instance->getRenderedChildComponentId('SvODwIc');
    $componentTag = $_instance->getRenderedChildComponentTagName('SvODwIc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SvODwIc');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('SvODwIc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
