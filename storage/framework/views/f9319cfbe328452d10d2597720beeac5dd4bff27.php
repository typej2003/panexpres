...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('hRHI8cy')) {
    $componentId = $_instance->getRenderedChildComponentId('hRHI8cy');
    $componentTag = $_instance->getRenderedChildComponentTagName('hRHI8cy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hRHI8cy');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('hRHI8cy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('BH7OTK5')) {
    $componentId = $_instance->getRenderedChildComponentId('BH7OTK5');
    $componentTag = $_instance->getRenderedChildComponentTagName('BH7OTK5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BH7OTK5');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('BH7OTK5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('3LVGTtx')) {
    $componentId = $_instance->getRenderedChildComponentId('3LVGTtx');
    $componentTag = $_instance->getRenderedChildComponentTagName('3LVGTtx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3LVGTtx');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('3LVGTtx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
