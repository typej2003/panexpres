...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('viuiTNu')) {
    $componentId = $_instance->getRenderedChildComponentId('viuiTNu');
    $componentTag = $_instance->getRenderedChildComponentTagName('viuiTNu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('viuiTNu');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('viuiTNu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('pWWjwcU')) {
    $componentId = $_instance->getRenderedChildComponentId('pWWjwcU');
    $componentTag = $_instance->getRenderedChildComponentTagName('pWWjwcU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pWWjwcU');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('pWWjwcU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('b5lDjln')) {
    $componentId = $_instance->getRenderedChildComponentId('b5lDjln');
    $componentTag = $_instance->getRenderedChildComponentTagName('b5lDjln');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('b5lDjln');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('b5lDjln', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
