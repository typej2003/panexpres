...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('av7HoZX')) {
    $componentId = $_instance->getRenderedChildComponentId('av7HoZX');
    $componentTag = $_instance->getRenderedChildComponentTagName('av7HoZX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('av7HoZX');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('av7HoZX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('KOeyBWT')) {
    $componentId = $_instance->getRenderedChildComponentId('KOeyBWT');
    $componentTag = $_instance->getRenderedChildComponentTagName('KOeyBWT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KOeyBWT');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('KOeyBWT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('ZMPDvSY')) {
    $componentId = $_instance->getRenderedChildComponentId('ZMPDvSY');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZMPDvSY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZMPDvSY');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('ZMPDvSY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
