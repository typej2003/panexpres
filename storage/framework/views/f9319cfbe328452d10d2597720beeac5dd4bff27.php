...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('6McvvuX')) {
    $componentId = $_instance->getRenderedChildComponentId('6McvvuX');
    $componentTag = $_instance->getRenderedChildComponentTagName('6McvvuX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6McvvuX');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('6McvvuX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('njkbdkb')) {
    $componentId = $_instance->getRenderedChildComponentId('njkbdkb');
    $componentTag = $_instance->getRenderedChildComponentTagName('njkbdkb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('njkbdkb');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('njkbdkb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('G5cnoUA')) {
    $componentId = $_instance->getRenderedChildComponentId('G5cnoUA');
    $componentTag = $_instance->getRenderedChildComponentTagName('G5cnoUA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('G5cnoUA');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('G5cnoUA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\typej\Documents\git\panexpres\resources\views/cart/cart.blade.php ENDPATH**/ ?>