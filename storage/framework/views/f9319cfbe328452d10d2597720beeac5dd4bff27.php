...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('pqmjWTo')) {
    $componentId = $_instance->getRenderedChildComponentId('pqmjWTo');
    $componentTag = $_instance->getRenderedChildComponentTagName('pqmjWTo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pqmjWTo');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('pqmjWTo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('s1INNnS')) {
    $componentId = $_instance->getRenderedChildComponentId('s1INNnS');
    $componentTag = $_instance->getRenderedChildComponentTagName('s1INNnS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s1INNnS');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('s1INNnS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('GARbQEg')) {
    $componentId = $_instance->getRenderedChildComponentId('GARbQEg');
    $componentTag = $_instance->getRenderedChildComponentTagName('GARbQEg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GARbQEg');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('GARbQEg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
