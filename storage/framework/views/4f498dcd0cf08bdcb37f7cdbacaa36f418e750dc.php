...
} elseif ($_instance->childHasBeenRendered('l1312289272-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1312289272-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1312289272-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1312289272-0');
} else {
    $response = \Livewire\Livewire::mount('components.navigation-map', ['comercio_id' => $comercio_id]);
    $html = $response->html();
    $_instance->logRenderedChild('l1312289272-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH /home/typej/Documentos/laravel/panexpres/resources/views/livewire/layouts/footer.blade.php ENDPATH**/ ?>