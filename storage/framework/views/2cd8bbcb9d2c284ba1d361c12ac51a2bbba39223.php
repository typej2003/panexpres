                ...
                <div class="row mb-2">
                    <div class="col-md-4">
                        <div style="width:100%; height: 80%;">
                            <img class="img-responsive" src="<?php echo e($product->image1_url); ?>" alt="">
                        </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l2302655051-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2302655051-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2302655051-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2302655051-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l2302655051-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
    ...
    <?php /**PATH C:\Users\typej\Documents\git\panexpres\resources\views/livewire/afiliado/view-details.blade.php ENDPATH**/ ?>