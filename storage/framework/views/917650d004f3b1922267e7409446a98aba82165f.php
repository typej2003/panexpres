...
} elseif ($_instance->childHasBeenRendered('l3688397075-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3688397075-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3688397075-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3688397075-0');
} else {
    $response = \Livewire\Livewire::mount('components.navigation-map', ['comercio_id' => $comercio_id]);
    $html = $response->html();
    $_instance->logRenderedChild('l3688397075-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH C:\Users\typej\Documents\git\panexpres-1\resources\views/livewire/layouts/footer.blade.php ENDPATH**/ ?>