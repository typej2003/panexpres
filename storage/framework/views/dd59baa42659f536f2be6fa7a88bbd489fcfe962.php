...
} elseif ($_instance->childHasBeenRendered('l1869340673-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1869340673-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1869340673-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1869340673-0');
} else {
    $response = \Livewire\Livewire::mount('carrito.cart-drop', ['currencyValue' => $currencyValue ]);
    $html = $response->html();
    $_instance->logRenderedChild('l1869340673-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('l1869340673-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1869340673-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1869340673-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1869340673-1');
} else {
    $response = \Livewire\Livewire::mount('components.currency');
    $html = $response->html();
    $_instance->logRenderedChild('l1869340673-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/typej/Documentos/laravel/panexpres/resources/views/livewire/layouts/navbar-in.blade.php ENDPATH**/ ?>