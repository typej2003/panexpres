...
} elseif ($_instance->childHasBeenRendered('l3436056991-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3436056991-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3436056991-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3436056991-0');
} else {
    $response = \Livewire\Livewire::mount('admin.profile.basic-data', ['user_id' => auth()->user()->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('l3436056991-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('l3436056991-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3436056991-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3436056991-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3436056991-1');
} else {
    $response = \Livewire\Livewire::mount('admin.profile.billing-details', ['user_id' => auth()->user()->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('l3436056991-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/typej/Documentos/laravel/panexpres/resources/views/livewire/admin/profile/update-profile.blade.php ENDPATH**/ ?>