        ...
        <div class="footer-row footer-row-1">
            ...
            <div class="footer-col footer-col-logo">
                ...
                <div class="social-links">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=+584168349158&text='Hola, te asesoramos por  whatsapp gestiona tu compra por este canal.'" class="social-icon whatsapp"><i class="fab fa-whatsapp"></i></a>
