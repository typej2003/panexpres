<div>
    <div class="container-fluid text-center">
        ...
        <p class="w-75 mx-auto fw-bold">
            Marketplace Seguro y Eficiente:
        </p>
        <p class="w-75 mx-auto">
        ...
        <p class="w-75 mx-auto">
            Mayor Alcance: Al unir fuerzas con PanExprés, las panaderías y negocios relacionados pueden expandir su presencia en el mercado digital.
        </p>
        <p class="w-75 mx-auto">
            Procesos Simplificados: Nos encargamos de la logística, lo que permite a nuestros aliados centrarse en lo que mejor saben hacer: ofrecer productos de calidad.
        </p>
        <p class="w-75 mx-auto fw-bold">
            Para Nuestros Clientes:
        </p>
        <p class="w-75 mx-auto">
            Comodidad y Variedad: Los clientes pueden explorar una amplia gama de productos de diferentes panaderías y negocios afines en un solo lugar, con la facilidad de realizar todas sus compras en una sola transacción.
        </p>
        <p class="w-75 mx-auto">
            Seguridad y Confianza: Al operar a través de PanExprés, los clientes pueden estar seguros de que sus compras serán gestionadas de manera segura y profesional.
        </p>
        <p class="w-75 mx-auto mb-5">
            En PanExprés, trabajamos incansablemente para crear un entorno donde la calidad, la seguridad y la satisfacción del cliente son nuestras principales prioridades. ¡Únete a nosotros y experimenta la diferencia!
        </p>
