...
namespace App\Http\Livewire\Distribucion;
...
class ListUsuariosDistribucion extends AdminComponent
{
	use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.distribucion.list-usuarios-distribucion', [
        	'users' => $userscomercio,
